...
function agregarAccionClick(id, caracter) {
...
let teclas = [{ "id": "borrarCaracter", "clases": "btn-danger operacion", "texto": "&lt;--", "orden": 10 },
{ "id": "inicializar", "clases": "btn-danger operacion", "texto": "C/AC", "orden": 20 },
{ "id": "masmenos", "clases": "btn-warning operacion", "texto": "+/-", "orden": 30 },
{ "id": "porcentaje", "clases": "btn-warning operacion", "texto": "%", "orden": 40 },
{ "id": "dividir", "clases": "btn-secondary operacion", "texto": "/", "orden": 50 },
{ "id": "siete", "clases": "btn-primary valor", "texto": "7", "orden": 60 },
{ "id": "ocho", "clases": "btn-primary valor", "texto": "8", "orden": 70 },
{ "id": "nueve", "clases": "btn-primary valor", "texto": "9", "orden": 80 },
{ "id": "multiplicar", "clases": "btn-secondary operacion", "texto": "*", "orden": 90 },
{ "id": "cuatro", "clases": "btn-primary valor", "texto": "4", "orden": 100 },
{ "id": "cinco", "clases": "btn-primary valor", "texto": "5", "orden": 110 },
{ "id": "seis", "clases": "btn-primary valor", "texto": "6", "orden": 120 },
{ "id": "restar", "clases": "btn-secondary operacion", "texto": "-", "orden": 130 },
{ "id": "uno", "clases": "btn-primary valor", "texto": "1", "orden": 140 },
{ "id": "dos", "clases": "btn-primary valor", "texto": "2", "orden": 150 },
{ "id": "tres", "clases": "btn-primary valor", "texto": "3", "orden": 160 },
{ "id": "sumar", "clases": "btn-secondary operacion", "texto": "+", "orden": 170 },
{ "id": "cero", "clases": "btn-primary valor0", "texto": "0", "orden": 180 },
{ "id": "comadecimal", "clases": "btn-primary valor", "texto": ".", "orden": 190 },
{ "id": "igual", "clases": "btn-secondary operacion", "texto": "=", "orden": 200 }
]
let calculadora = document.getElementById("calculadora");
calculadora.innerHTML = `<div class="visor"><div id="formula">=></div><div id="resultado">0</div></div>`;
teclas.sort((a, b) => { return parseInt(a.orden) - parseInt(b.orden) }).forEach((tecla) => { calculadora.innerHTML += `<button id="${tecla.id}" class="btn ${tecla.clases}">${tecla.texto}</button>` });
